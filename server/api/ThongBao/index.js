...
module.exports = function(app) {
    ...
    app.get("/TotalPageDSThongBaoKH/:id_kh", async(req,res)=>{
        try {
    ...
    app.get('/TotalDSThongBaoKH/:id_kh' , async(req,res)=>{
        try {
            const {id_kh} = req.params
           //  console.log(id_kh)
            const newQuery = await pool.query(`
